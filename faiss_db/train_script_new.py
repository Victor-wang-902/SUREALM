...
if __name__ == "__main__":
    ...
    if not args.from_checkpoint and not args.not_retrieval:
        update_config(args)
    else:
    ...
    args.optimizer = AdamW(params=args.model.parameters(), lr=1e-6, correct_bias=True)
