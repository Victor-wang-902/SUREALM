...
from transformers.models.roberta.modeling_roberta import RobertaSelfAttention, RobertaAttention, RobertaLayer, RobertaEncoder, RobertaModel
...
class RetrievalRobertaLayer(RobertaLayer):
    def __init__(self, config):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = RetrievalAttentionRoberta(config, position_embedding_type="absolute")
